-- coin insert logic, balance check logic, transition to DISPENSE, display inserted amount and price
library IEEE;
...
begin
    for i in 0 to 3 loop
        case name_str(i+1) is
            ...
            when others => show_left(i*4+3 downto i*4) <= "1111";
        end case;
    end loop;
end process;
...
begin
    ...
    show_right(15 downto 12) <= conv_std_logic_vector(0, 4);
...
begin
    if rising_edge(clk) then
        ...
        case digit_value is
            when "0000" => seg_data <= "0000001";
            when "0001" => seg_data <= "1001111";
            when "0010" => seg_data <= "0010010";
            when "0011" => seg_data <= "0000110";
            when "0100" => seg_data <= "1001100";
            when "0101" => seg_data <= "0100100";
            when "0110" => seg_data <= "0100000";
            when "0111" => seg_data <= "0001111";
            when "1000" => seg_data <= "0000000";
            when "1001" => seg_data <= "0000100";
